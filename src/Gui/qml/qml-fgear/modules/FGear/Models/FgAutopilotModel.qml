...
are independent of the arming process thus providing full time alerting, even when the autopilot is disengaged."
    ...
    ListElement {
        itemText: "BAR0"
        name: "bar0_set"
        itemSource: "BaseAutopilotButton.qml"
        row: 0; rowSpan: 1
